...
2020年，形成的一个新习惯。就是一切从wikipedia出发，在自己digital garden中种下这个概念，然后google进行最初的打磨，如果可以，就分享到自己[knowledge](https://github.com/willwang-x/knowledge)中，如果有需要，在Anki中细细打磨。
